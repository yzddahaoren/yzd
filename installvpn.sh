...
function set_daloradius5(){
	cd /var/www/html/
	wget https://github.com/yzddahaoren/yzd/blob/master/daloradius-0.9-9.tar.gz >/dev/null 2>&1
...
function set_fix_radacct_table7(){
	cd /tmp
	sleep 3
	wget https://github.com/yzddahaoren/yzd/blob/master/radacct_new.sql.tar.gz
...
function set_openvpn_freeradius9(){
	...
	cd /tmp
	wget https://github.com/yzddahaoren/yzd/blob/master/radiusplugin_v2.1a_beta1.tar.gz
...
cd /var/www/html/
rm -rf *
wget https://github.com/yzddahaoren/yzd/blob/master/daloradius20180418.tar.gz 
tar xzvf daloradius20180418.tar.gz 
rm -rf daloradius20180418.tar.gz
wget https://github.com/yzddahaoren/yzd/blob/master/user_reg_new20180418.tar.gz
...
mkdir /usr/mysys/
cd /usr/mysys/
wget https://github.com/yzddahaoren/yzd/blob/master/dbback.tar.gz
...
cd /root/
wget https://github.com/yzddahaoren/yzd/blob/master/initvpn20180418.zip
